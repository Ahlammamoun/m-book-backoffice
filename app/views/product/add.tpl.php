<div class="container my-4">
        ...
        <form action="" method="POST" class="mt-5">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="Nom du produit" required>
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea id="description" class="form-control" placeholder="Description du produit" ></textarea>
            ...
            <div class="mb-3">
                ...
                <input type="number" min="0" step="0.01" class="form-control" id="price" placeholder="Le prix du Produit" required>
            </div>
            <div class="mb-3">
                <label for="rate" class="form-label">Note</label>
                <input type="number" class="form-control"min="1" max="5" id="rate" placeholder="La note du produit" required>
            </div>
            <div class="mb-3">
                <label class="form-label" >Status du produit</label >
                <label for="status_available" class="form-label">Disponible</label>
                <input type="radio" id="status_available" name="status" checked required>
                <label for="status_not_available" class="form-label">Indisponible</label>
                <input type="radio" id="status_not_available" name="status" required >
