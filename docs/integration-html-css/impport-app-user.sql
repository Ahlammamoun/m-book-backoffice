...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `app_user` (`id`, `email`, `password`, `firstname`, `lastname`, `role`, `status`, `created_at`, `updated_at`) VALUES (1, 'mestar.ale@gmail.com', 'ahlammamoun', 'Ahlam', 'Mamoun', 'admin', 1, DEFAULT, NULL);
